...
<head>
    ...
    <title>@yield('title', 'TechStore') - E-Commerce Platform</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background: white; box-shadow: 0 2px 8px rgba(0,0,0,0.1); padding: 0;">
        <div class="container-fluid" style="padding: 15px 20px; max-width: 1200px; margin: 0 auto;">
            <a class="navbar-brand" href="{{ route('home') }}" style="display: flex; align-items: center; gap: 10px; padding: 0; border: none; background: none;">
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    @auth
                        @if(Auth::user()->isAdmin())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin') }}" style="color: var(--danger) !important;">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                                ...
                                <li><form method="POST" action="{{ route('logout') }}" style="margin: 0;">
                                    @csrf
                    ...
                    <li class="nav-item">
                        <a class="nav-link position-relative" href="{{ route('cart.index') }}" style="margin-left: 1rem;">
