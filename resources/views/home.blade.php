...
<nav class="navbar">
    <div class="nb-inner">
        ...
        <form class="search-box" action="{{ route('products.index') }}" method="GET">
            <input type="text" name="search" placeholder="Search products, brands..." value="{{ request('search','') }}">
        ...
        <div class="nav-actions">
            @auth
                ...
                <a href="{{ route('profile.show') }}" class="nav-btn">
                    @if($user->face_photo)
                        <img src="{{ $user->face_photo }}" style="width:26px;height:26px;border-radius:50%;object-fit:cover;border:2px solid rgba(255,255,255,.5);vertical-align:middle;margin-right:3px">
                    @else
                        <i class="fas fa-user-circle"></i>
                    @endif
                    <span>{{ Str::limit($user->name,10) }}</span>
                </a>
                <a href="{{ route('wishlist') }}" class="nav-btn"><i class="fas fa-heart"></i><span>Wishlist</span></a>
                <a href="{{ route('notifications.index') }}" class="nav-btn"><i class="fas fa-bell"></i><span>Notifications</span></a>
                <a href="{{ route('logout') }}" class="nav-btn" onclick="event.preventDefault();document.getElementById('lf').submit()"><i class="fas fa-sign-out-alt"></i><span>Sign Out</span></a>
                <form id="lf" action="{{ route('logout') }}" method="POST" style="display:none">@csrf</form>
            @else
                <a href="{{ route('login') }}" class="nav-btn"><i class="fas fa-sign-in-alt"></i><span>Sign In</span></a>
                <a href="{{ route('register') }}" class="nav-btn reg"><i class="fas fa-user-plus"></i><span>Sign Up</span></a>
            @endauth
            <a href="{{ route('cart.index') }}" class="nav-btn" id="cart-nav-btn" style="position:relative">
                <i class="fas fa-shopping-cart"></i><span>Cart</span>
                @php $cartCount = array_sum(session()->get('cart',[])); @endphp
                @if($cartCount > 0)<span class="cart-badge" id="cart-badge">{{ $cartCount }}</span>@endif
            </a>
        </div>
...
<div class="mobile-drawer" id="mobileDrawer">
    ...
    <div class="drawer-panel">
        ...
        <nav class="drawer-nav">
            ...
            <a href="{{ route('products.index') }}?category=protection"><i class="fas fa-shield-alt"></i> Protection &amp; Decor</a>
            <a href="{{ route('products.index') }}?category=office"><i class="fas fa-briefcase"></i> Office</a>
            <a href="{{ route('products.index') }}" style="font-weight:700;color:var(--green) !important"><i class="fas fa-star"></i> All Products</a>
            ...
            <a href="{{ route('profile.show') }}"><i class="fas fa-user-circle"></i> My Profile</a>
            <a href="{{ route('orders.index') }}"><i class="fas fa-box-open"></i> My Orders</a>
            <a href="{{ route('wishlist') }}"><i class="fas fa-heart"></i> Wishlist</a>
            <a href="{{ route('notifications.index') }}"><i class="fas fa-bell"></i> Notifications</a>
            <a href="{{ route('compare.index') }}"><i class="fas fa-balance-scale"></i> Compare</a>
            <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('lf').submit()"><i class="fas fa-sign-out-alt"></i> Sign Out</a>
            @else
            <div class="drawer-footer">
                <a href="{{ route('login') }}" class="drawer-btn-login"><i class="fas fa-sign-in-alt"></i> Sign In</a>
                <a href="{{ route('register') }}" class="drawer-btn-signup"><i class="fas fa-user-plus"></i> Sign Up</a>
            </div>
            @endauth
        </nav>
    </div>
...
<div class="cat-nav">
    <div class="cn-inner">
        <div class="ci"><a href="{{ route('home') }}"><i class="fas fa-home"></i> Home</a></div>
        <div class="ci"><a href="{{ route('about') }}"><i class="fas fa-info-circle"></i> About</a></div>
        <div class="ci">
            ...
            <div class="c-drop">
                ...
                <a href="{{ route('products.index') }}?category=protection"><i class="fas fa-shield-alt"></i> Protection &amp; Decor</a>
                <a href="{{ route('products.index') }}?category=office"><i class="fas fa-briefcase"></i> Office</a>
                <a href="{{ route('products.index') }}" style="font-weight:700;color:var(--green) !important"><i class="fas fa-star"></i> View all products</a>
            </div>
        </div>
        <div class="ci">
        ...
        <div class="ci"><a href="{{ route('contact') }}"><i class="fas fa-envelope"></i> Contact</a></div>
        <div class="ci"><a href="{{ route('news') }}"><i class="fas fa-newspaper"></i> News</a></div>
        @auth
        <div class="ci ci-ml"><a href="{{ route('orders.index') }}"><i class="fas fa-box-open"></i> My Orders</a></div>
        <div class="ci"><a href="{{ route('compare.index') }}"><i class="fas fa-balance-scale"></i> Compare</a></div>
        @endauth
    </div>
</div>
...
<section class="hero">
    <div class="hero-inner">
        <div>
            ...
            <div class="hero-btns">
                <a href="{{ route('products.index') }}" class="btn-hp"><i class="fas fa-shopping-bag"></i> Buy Now</a>
        ...
        <div class="hero-cards">
            <a href="{{ route('products.index') }}?category=gaming" class="hc a"><i class="fas fa-gamepad"></i><div class="hc-t">Gaming Gear</div><div class="hc-s">Top performance</div></a>
            <a href="{{ route('products.index') }}?category=peripherals" class="hc b"><i class="fas fa-keyboard"></i><div class="hc-t">Mechanical Keyboard</div><div class="hc-s">Amazing typing feel</div></a>
            <a href="{{ route('products.index') }}?category=audio" class="hc c"><i class="fas fa-headphones-alt"></i><div class="hc-t">Hi-Fi Headphones</div><div class="hc-s">Vivid sound</div></a>
            <a href="{{ route('products.index') }}?category=monitor" class="hc d"><i class="fas fa-desktop"></i><div class="hc-t">4K Monitor</div><div class="hc-s">Ultra-sharp display</div></a>
        </div>
    </div>
</section>
...
<div class="sw">
    <div class="sec-hdr">
        ...
        <a href="{{ route('products.index') }}" class="sec-link">All Categories <i class="fas fa-arrow-right"></i></a>
    </div>
    <div class="cat-grid">
        <a href="{{ route('products.index') }}?category=gaming"      class="cat-card"><div class="cat-ico"><i class="fas fa-gamepad"></i></div><div class="cat-name">Gaming</div><div class="cat-sub">Gear &amp; Setup</div></a>
        <a href="{{ route('products.index') }}?category=peripherals" class="cat-card"><div class="cat-ico"><i class="fas fa-mouse"></i></div><div class="cat-name">Peripherals</div><div class="cat-sub">Mouse, keyboard</div></a>
        <a href="{{ route('products.index') }}?category=storage"     class="cat-card"><div class="cat-ico"><i class="fas fa-hdd"></i></div><div class="cat-name">Storage</div><div class="cat-sub">SSD, USB, HDD</div></a>
        <a href="{{ route('products.index') }}?category=power"       class="cat-card"><div class="cat-ico"><i class="fas fa-plug"></i></div><div class="cat-name">Power &amp; Cooling</div><div class="cat-sub">PSU, cooler</div></a>
        <a href="{{ route('products.index') }}?category=protection"  class="cat-card"><div class="cat-ico"><i class="fas fa-shield-alt"></i></div><div class="cat-name">Protection</div><div class="cat-sub">Cases &amp; accessories</div></a>
        <a href="{{ route('products.index') }}?category=office"      class="cat-card"><div class="cat-ico"><i class="fas fa-briefcase"></i></div><div class="cat-name">Office</div><div class="cat-sub">High performance</div></a>
    </div>
</div>
...
<div class="sw sw0" id="san-pham-moi">
    <div class="sec-hdr">
        ...
        <a href="{{ route('products.index') }}" class="sec-link" style="margin-left:24px">View all <i class="fas fa-arrow-right"></i></a>
    </div>
    <div class="prod-grid">
        ...
        <div class="prod-card">
            ...
            <div class="prod-body">
                ...
                @if($product->rating)
                <div class="stars">@for($i=0;$i<5;$i++)<i class="{{ $i < $product->rating ? 'fas' : 'far' }} fa-star"></i>@endfor<span>({{ $product->reviews_count ?? 0 }})</span></div>
                @endif
                <div class="prod-price">
                    <span class="price-now">${{ number_format($flashPrice, 2) }}</span>
    ...
    <div class="va-wrap"><a href="{{ route('products.index') }}" class="btn-va"><i class="fas fa-th-large"></i> View all products</a></div>
</div>
...
<div class="sw sw0">
    <div class="sec-hdr">
        ...
        <a href="{{ route('products.index') }}" class="sec-link">View more <i class="fas fa-arrow-right"></i></a>
    </div>
    <div class="prod-grid">
        ...
        <div class="prod-card">
            ...
            <div class="prod-body">
                <a href="{{ route('product.show', $product->id) }}" class="prod-name">{{ $product->name }}</a>
                @if($product->rating)
                <div class="stars">@for($i=0;$i<5;$i++)<i class="{{ $i < $product->rating ? 'fas' : 'far' }} fa-star"></i>@endfor</div>
                @endif
                <div class="prod-price">
    ...
    <div class="va-wrap"><a href="{{ route('products.index') }}" class="btn-va"><i class="fas fa-arrow-right"></i> View all featured products</a></div>
</div>
...
<div class="sw sw0">
    ...
    <div class="brands-row">
        <a href="{{ route('products.index') }}?brand=Logitech" class="brand-card"><img src="/images/Logitech.png" alt="Logitech"></a>
        <a href="{{ route('products.index') }}?brand=ASUS" class="brand-card"><img src="/images/azus.png" alt="ASUS"></a>
        <a href="{{ route('products.index') }}?brand=Razer" class="brand-card"><img src="/images/razer.png" alt="Razer"></a>
        <a href="{{ route('products.index') }}?brand=Corsair" class="brand-card"><img src="/images/corsair.png" alt="Corsair"></a>
        <a href="{{ route('products.index') }}?brand=SteelSeries" class="brand-card"><img src="/images/steel.png" alt="SteelSeries"></a>
    </div>
</div>
...
<div id="compare-bar" style="display:none;position:fixed;bottom:0;left:0;right:0;background:#1a2540;color:#fff;padding:12px 20px;z-index:1000;align-items:center;gap:12px;justify-content:center;box-shadow:0 -4px 20px rgba(0,0,0,.4)">
    ...
    <a href="{{ route('compare.index') }}" style="background:#3b82f6;color:#fff;padding:7px 18px;border-radius:50px;text-decoration:none;font-size:13px;font-weight:700">Compare ngay</a>
