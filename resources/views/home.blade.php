...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-content">
            ...
            <form class="search-container" style="margin: 0 30px; flex: 1;" action="{{ route('products.index') }}" method="GET">
            ...
            <div class="nav-icons">
                ...
                <a href="{{ route('cart.index') }}" style="position: relative;">
                    ...
                    @endphp
                    @if($cartCount > 0)
                        <span style="position: absolute; top: -5px; right: -5px; background: #ff6b6b; color: white; border-radius: 50%; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: bold;">{{ $cartCount }}</span>
                    @endif
                </a>
            </div>
        </div>
        ...
        <div class="category-menu-content">
            ...
            <div class="category-menu-item">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{ route('products.index') }}?category=peripherals"><i class="fas fa-mouse"></i> Phụ kiện ngoại vi</a></li>
                    <li><a href="{{ route('products.index') }}?category=storage"><i class="fas fa-hdd"></i> Lưu trữ & kết nối</a></li>
                    <li><a href="{{ route('products.index') }}?category=power"><i class="fas fa-plug"></i> Nguồn & làm mát</a></li>
                    <li><a href="{{ route('products.index') }}?category=protection"><i class="fas fa-shield-alt"></i> Bảo vệ & trang trí</a></li>
                    <li><a href="{{ route('products.index') }}?category=gaming"><i class="fas fa-gamepad"></i> Gaming</a></li>
                    <li><a href="{{ route('products.index') }}?category=security"><i class="fas fa-lock"></i> Bảo mật</a></li>
                    <li><a href="{{ route('products.index') }}?category=office"><i class="fas fa-briefcase"></i> Văn phòng</a></li>
                    <li style="border-top: 1px solid #ddd; margin-top: 8px; padding-top: 8px;"><a href="{{ route('products.index') }}" style="font-weight: 600; color: #00b894;"><i class="fas fa-star"></i> Xem tất cả sản phẩm</a></li>
                </ul>
            </div>
            <div class="category-menu-item">
                <a href="#" class="dropdown-toggle">HỖ TRỢ</a>
                <ul class="dropdown-menu">
                    <li><a href="{{ route('contact') }}"><i class="fas fa-question-circle"></i> Trung tâm trợ giúp</a></li>
        ...
        <div class="sidebar">
            <div class="sidebar-section">
                ...
                <ul class="sidebar-list">
                    <li><a href="/?category=peripherals" class="@if(request('category') == 'peripherals') active @endif"><i class="fas fa-mouse"></i> Phụ kiện ngoại vi</a></li>
                    <li><a href="/?category=storage" class="@if(request('category') == 'storage') active @endif"><i class="fas fa-hdd"></i> Lưu trữ & kết nối</a></li>
                    <li><a href="/?category=power" class="@if(request('category') == 'power') active @endif"><i class="fas fa-plug"></i> Nguồn & làm mát</a></li>
                    <li><a href="/?category=protection" class="@if(request('category') == 'protection') active @endif"><i class="fas fa-shield-alt"></i> Bảo vệ & trang trí</a></li>
                    <li><a href="/?category=gaming" class="@if(request('category') == 'gaming') active @endif"><i class="fas fa-gamepad"></i> Gaming</a></li>
                    <li><a href="/?category=security" class="@if(request('category') == 'security') active @endif"><i class="fas fa-lock"></i> Bảo mật</a></li>
                    <li><a href="/?category=office" class="@if(request('category') == 'office') active @endif"><i class="fas fa-briefcase"></i> Văn phòng</a></li>
                </ul>
            </div>
            ...
            @forelse($products as $product)
                <div class="product-card">
                    <div class="product-image">
                        ...
                        <img src="{{ $product->image ?? 'https://via.placeholder.com/200x200?text=' . urlencode($product->name) }}{{ $product->image ? '?v=' . md5($product->updated_at) : '' }}" alt="{{ $product->name }}">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="product-actions" style="display: flex; gap: 8px;">
                            <a href="{{ route('product.show', $product->id) }}" style="flex: 1; display: flex; align-items: center; justify-content: center; background: #00b894; color: white; border: none; border-radius: 3px; cursor: pointer; font-size: 12px; font-weight: 600; text-decoration: none; transition: background 0.3s;">
