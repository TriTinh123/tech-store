...
<head>
    ...
    <title>Enroll Face — {{ config('app.name') }}</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    {{-- Load face-api.js without defer so it's available immediately --}}
...
<div class="card">
    ...
    {{-- Face snapshot preview shown after successful capture --}}
    ...
    <form method="POST" action="{{ route('auth.face.enroll') }}" id="enrollForm">
        @csrf
    ...
    <a href="{{ route('profile.show') }}" class="btn btn-back" style="display:block;text-align:center;text-decoration:none;">
        ← Back to Profile
    </a>
</div>
