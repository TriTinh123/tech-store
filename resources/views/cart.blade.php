    ...
    <div class="col-lg-8">
        <div class="bg-white rounded-4 border" style="border-color:var(--border)!important">
            <div class="d-flex align-items-center justify-content-between px-4 py-3 border-bottom">
                ...
                <span class="badge rounded-pill" style="background:var(--green)">{{ count($items) }} products</span>
            </div>
    ...
    <div class="col-lg-4">
        <div class="summary-card">
            ...
            <div class="summary-row">
                ...
                <span class="fw-600">${{ number_format($total, 2) }}</span>
            </div>
            <div class="summary-row">
            ...
            <a href="{{ route('checkout.show') }}" class="btn-checkout mt-4">
...
<div class="empty-cart-box">
    ...
    <a href="{{ url('/') }}" class="btn btn-success rounded-pill px-5 py-2 fw-600">
        <i class="fas fa-arrow-left me-2"></i>Continue shopping
    </a>
</div>
@endif
