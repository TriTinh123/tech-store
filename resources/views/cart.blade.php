...
<body>
    ...
    <div class="container">
        <div class="page-title">
            <i class="fas fa-shopping-cart"></i> Giỏ hàng ({{ count($items) }} sản phẩm)
        </div>
                    ...
                    @foreach ($items as $item)
                        <div class="cart-item">
                            <div class="item-image">
                                <img src="{{ $item['product']->image ?? 'https://via.placeholder.com/80x80?text=Sản+phẩm' }}" alt="{{ $item['product']->name }}">
                            </div>
                            <div class="item-info">
                            ...
                            <form action="{{ route('cart.remove', $item['product']->id) }}" method="POST" style="display: inline;" class="remove-form" data-product-id="{{ $item['product']->id }}">
                                @csrf
