...
<div class="sec-wrap">
    ...
    @endif
    @if($errors->any())
        <div class="flash flash-err"><i class="fas fa-exclamation-circle"></i> {{ $errors->first() }}</div>
    @endif

    {{-- ── Block 1: Sign-in verification ── --}}
    <div class="sec-block">
        ...
        <div class="sec-row">
            ...
            <div class="sec-row-right">
                ...
                <button class="row-action" onclick="toggle('sqForm')">
                    {{ $user->security_question ? 'Update' : 'Set up' }} →
                </button>
            </div>
        </div>
        <div class="expand-form" id="sqForm"
             style="{{ ($errors->has('security_question') || $errors->has('security_answer')) ? 'display:block' : '' }}">
        ...
        <div class="sec-row">
            <div class="sec-row-left">
                ...
                <div class="sec-row-info">
                    ...
                    <div class="desc">A sign-in confirmation link sent to {{ $user->email }}</div>
                </div>
            </div>
            <div class="sec-row-right">
                <span class="pill pill-green">Active</span>
        ...
        <div class="sec-row">
            <div class="sec-row-left">
                @if($user->face_photo)
                    <img src="{{ $user->face_photo }}" alt="Face"
            ...
            <div class="sec-row-right">
                ...
                @else
                    <span class="pill pill-yellow">Not set</span>
                @endif
                <a href="{{ route('auth.face.enroll.form') }}" class="row-action">
                    {{ $user->face_descriptor ? 'Update' : 'Set up' }} →
                </a>
            </div>
        </div>
        ...
        <div class="sec-row">
            <div class="sec-row-left">
                ...
                <div class="sec-row-info">
                    ...
                    <div class="desc">Last changed: {{ $user->updated_at->format('M d, Y') }}</div>
                </div>
            </div>
            <div class="sec-row-right">
                <a href="{{ route('profile.change-password') }}" class="row-action">Change →</a>
            </div>
        </div>
    </div>
