                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    <label for="original_price" class="form-label"><i class="fas fa-tag"></i> Giá Gốc</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control @error('image') is-invalid @enderror" 
                                           id="image" name="image" value="{{ old('image', $product->image) }}" placeholder="/images/product-name.jpg" oninput="previewImage()">
                                    <small class="text-muted">VD: /images/CorsairK95.jpg</small>
                                    @error('image')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="form-group mb-4">
                                    <label for="image_file" class="form-label"><i class="fas fa-upload"></i> Hoặc Upload Ảnh Mới</label>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div style="border: 2px dashed #e9ecef; border-radius: 8px; padding: 20px; text-align: center; min-height: 200px; background: #f8f9fa;">
                                        <img id="imagePreview" src="{{ $product->image ?? 'https://via.placeholder.com/200x200?text=No+Image' }}" 
                        ...
                        <div class="form-group mb-4">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" 
                                       value="1" @if(old('is_featured', $product->is_featured)) checked @endif>
