        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="PUT" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $product->name) }}" required placeholder="Enter product name" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
                    @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label" style="font-weight: 600; color: #2d3748; display: block; margin-bottom: 0.5rem;">Slug *</label>
                    <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug', $product->slug) }}" required placeholder="product-slug" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" placeholder="Enter product description" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">{{ old('description', $product->description) }}</textarea>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="manufacturer" class="form-control" value="{{ old('manufacturer', $product->manufacturer) }}" placeholder="Manufacturer name" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $product->price) }}" required min="0" step="0.01" placeholder="0.00" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="original_price" class="form-control" value="{{ old('original_price', $product->original_price) }}" min="0" step="0.01" placeholder="0.00" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
                </div>
                <div class="col-md-4">
                    <label class="form-label" style="font-weight: 600; color: #2d3748; display: block; margin-bottom: 0.5rem;">Stock *</label>
                    <input type="number" name="stock" class="form-control @error('stock') is-invalid @enderror" value="{{ old('stock', $product->stock) }}" required min="0" placeholder="0" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
