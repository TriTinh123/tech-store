...
<?php $__env->startSection('title', 'Admin Reports Dashboard'); ?>
...
<div class="container-fluid mt-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            ...
            ?>
            <p class="text-muted">Chào mừng, <?php echo e($userName); ?> 👋</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h2 class="stats-value" style="color: #48bb78;">₫<?php echo e(number_format($stats['total_revenue'], 0, ',', '.')); ?></h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h2 class="stats-value" style="color: #4299e1;"><?php echo e(number_format($stats['total_orders'])); ?></h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h2 class="stats-value" style="color: #ed8936;"><?php echo e(number_format($stats['total_products'])); ?></h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h2 class="stats-value" style="color: #9f7aea;"><?php echo e(number_format($stats['total_users'])); ?></h2>
                        </div>
        ...
        <div style="background: white; border-radius: 8px; width: 90%; max-width: 700px; max-height: 80vh; overflow-y: auto; box-shadow: 0 5px 25px rgba(0,0,0,0.3);">
            ...
            <div id="security-modal-alerts" data-security-modal style="padding: 20px; display: none;">
                <div class="alert alert-info">
                    <strong>Tổng cảnh báo:</strong> <?php echo e(count($securityAlerts)); ?>
                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong><?php echo e($alert['type']); ?></strong></td>
                            <td><?php echo e($alert['description']); ?></td>
                            <td><span class="badge bg-danger"><?php echo e($alert['count']); ?></span></td>
                        </tr>
            ...
            <div id="security-modal-anomalies" data-security-modal style="padding: 20px; display: none;">
                    ...
                    <div class="col-md-12">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <h2 style="color: #f6ad55;"><?php echo e($securityMetrics['login_anomalies'] ?? 0); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="list-group">
                    <?php $__empty_1 = true; $__currentLoopData = $securityMetrics['recent_suspicious']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suspicious): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="list-group-item" style="border-left: 4px solid #f6ad55;">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h6 class="mb-1"><?php echo e($suspicious->user->name ?? 'Unknown'); ?></h6>
                                <small class="text-muted">
                                    🔍 IP: <?php echo e($suspicious->ip_address); ?><br>
                                    🌍 Quốc gia: <?php echo e($suspicious->country ?? 'Unknown'); ?><br>
                                    ⚠️ Risk Level: <span class="badge bg-<?php echo e($suspicious->risk_level == 'high' ? 'danger' : ($suspicious->risk_level == 'medium' ? 'warning' : 'info')); ?>"><?php echo e($suspicious->risk_level); ?></span>
                                </small>
                            </div>
                            <span class="badge bg-warning"><?php echo e($suspicious->created_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <h2 style="color: #805ad5;"><?php echo e($securityMetrics['failed_attempts'] ?? 0); ?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <h2 style="color: #c53030;"><?php echo e($securityMetrics['locked_accounts'] ?? 0); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php
                                $failedLogins = \App\Models\LoginAttempt::where('success', false)
                                    ...
                                    ->get();
                            ?>
                            <?php $__empty_1 = true; $__currentLoopData = $failedLogins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($attempt->user->email ?? 'Unknown'); ?></td>
                                <td><?php echo e($attempt->ip_address); ?></td>
                                <td><small><?php echo e($attempt->attempted_at->diffForHumans()); ?></small></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
            ...
            <div id="security-modal-concurrent" data-security-modal style="padding: 20px; display: none;">
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <h2 style="color: #3182ce;"><?php echo e($securityMetrics['concurrent_logins'] ?? 0); ?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <h2 style="color: #0284c7;"><?php echo e($securityMetrics['users_with_concurrent'] ?? 0); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="list-group">
                    <?php $__empty_1 = true; $__currentLoopData = $securityMetrics['recent_concurrent']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concurrent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="list-group-item" style="border-left: 4px solid #3182ce;">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h6 class="mb-1"><?php echo e($concurrent->user->name ?? 'Unknown'); ?> (<?php echo e($concurrent->user->email ?? ''); ?>)</h6>
                                <small class="text-muted">
                                    📍 IP 1: <?php echo e($concurrent->primary_ip_address); ?><br>
                                    📍 IP 2: <?php echo e($concurrent->secondary_ip_address); ?><br>
                                    ✓ Trạng thái: <span class="badge bg-danger"><?php echo e(ucfirst($concurrent->status)); ?></span>
                                </small>
                            </div>
                            <span class="badge bg-info"><?php echo e($concurrent->created_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <?php $__currentLoopData = $topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted"><?php echo e($product['sales']); ?> sales</small>
                                    </div>
                                    <span class="badge bg-warning">💰 $<?php echo e(number_format($product['revenue'], 2)); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    <?php else: ?>
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm" style="cursor: pointer;" onclick="openSecurityModal('alerts')">
                ...
                <div class="card-body">
                    <?php if(isset($securityAlerts) && count($securityAlerts) > 0): ?>
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = $securityAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item px-0 py-2 border-bottom">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <h6 class="mb-1"><?php echo e($alert['type'] ?? 'Security Alert'); ?></h6>
                                            <small class="text-muted"><?php echo e($alert['description'] ?? 'Alert'); ?></small>
                                        </div>
                                        <span class="badge bg-danger"><?php echo e($alert['count'] ?? 1); ?></span>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm" style="cursor: pointer;" onclick="openSecurityModal('anomalies')">
                ...
                <div class="card-body">
                    <?php if(isset($securityMetrics) && isset($securityMetrics['login_anomalies'])): ?>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <h4 style="color: #f6ad55; font-weight: bold;">
                                    <?php echo e($securityMetrics['login_anomalies'] ?? 0); ?>
                        ...
                        <hr>
                        <small class="text-muted">Cập nhật lần cuối: <?php echo e(now()->format('H:i:s, d/m/Y')); ?></small>
                    <?php else: ?>
                        <div class="alert alert-info">
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm" style="cursor: pointer;" onclick="openSecurityModal('failed')">
                ...
                <div class="card-body">
                    <?php if(isset($securityMetrics) && isset($securityMetrics['failed_attempts'])): ?>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <h4 style="color: #805ad5; font-weight: bold;">
                                    <?php echo e($securityMetrics['failed_attempts'] ?? 0); ?>
                        ...
                        <hr>
                        <?php if(isset($securityMetrics['locked_accounts'])): ?>
                            <small class="text-danger">
                                <strong><?php echo e($securityMetrics['locked_accounts'] ?? 0); ?></strong> tài khoản bị khóa
                            </small>
                        <?php endif; ?>
                    <?php else: ?>
                        <div class="alert alert-info">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm" style="cursor: pointer;" onclick="openSecurityModal('concurrent')">
                ...
                <div class="card-body">
                    <?php if(isset($securityMetrics) && isset($securityMetrics['concurrent_logins'])): ?>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <h4 style="color: #3182ce; font-weight: bold;">
                                    <?php echo e($securityMetrics['concurrent_logins'] ?? 0); ?>
                        ...
                        <hr>
                        <?php if(isset($securityMetrics['users_with_concurrent'])): ?>
                            <small class="text-muted">
                                <strong><?php echo e($securityMetrics['users_with_concurrent'] ?? 0); ?></strong> tài khoản bị ảnh hưởng
                            </small>
                        <?php endif; ?>
                    <?php else: ?>
                        <div class="alert alert-info">
    ...
    <div class="row mt-4 mb-4">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('admin.products')); ?>" class="card text-decoration-none admin-link-card" style="border-left: 4px solid #ed8936;">
                <div class="card-body text-center">
                    <i class="fas fa-box" style="font-size: 2rem; color: #ed8936;"></i>
                    <h6 class="mt-3">Quản Lý Sản Phẩm</h6>
                    <p class="text-muted mb-0"><?php echo e($stats['total_products']); ?> sản phẩm</p>
                </div>
            </a>
        </div>
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('admin.categories')); ?>" class="card text-decoration-none admin-link-card" style="border-left: 4px solid #9f7aea;">
                <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('admin.orders')); ?>" class="card text-decoration-none admin-link-card" style="border-left: 4px solid #4299e1;">
                <div class="card-body text-center">
                    <i class="fas fa-shopping-bag" style="font-size: 2rem; color: #4299e1;"></i>
                    <h6 class="mt-3">Quản Lý Đơn Hàng</h6>
                    <p class="text-muted mb-0"><?php echo e($stats['total_orders']); ?> đơn hàng</p>
                </div>
            </a>
        </div>
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('admin.users')); ?>" class="card text-decoration-none admin-link-card" style="border-left: 4px solid #48bb78;">
                <div class="card-body text-center">
                    <i class="fas fa-users" style="font-size: 2rem; color: #48bb78;"></i>
                    <h6 class="mt-3">Quản Lý Người Dùng</h6>
                    <p class="text-muted mb-0"><?php echo e($stats['total_users']); ?> người dùng</p>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('admin.security-settings.index')); ?>" class="card text-decoration-none admin-link-card" style="border-left: 4px solid #e53e3e;">
                <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('admin.security-settings.blocked-ips')); ?>" class="card text-decoration-none admin-link-card" style="border-left: 4px solid #f6ad55;">
                <div class="card-body text-center">
                    <i class="fas fa-ban" style="font-size: 2rem; color: #f6ad55;"></i>
                    <h6 class="mt-3">IP Bị Chặn</h6>
                    <p class="text-muted mb-0"><?php echo e(isset($securityMetrics['blocked_ips']) ? count($securityMetrics['blocked_ips']) : 0); ?> IP</p>
                </div>
            </a>
        </div>
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('admin.security-monitoring')); ?>" class="card text-decoration-none admin-link-card" style="border-left: 4px solid #805ad5;">
                <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('admin.anomalies.dashboard')); ?>" class="card text-decoration-none admin-link-card" style="border-left: 4px solid #3182ce;">
                <div class="card-body text-center">
                    <i class="fas fa-exclamation-triangle" style="font-size: 2rem; color: #3182ce;"></i>
                    <h6 class="mt-3">Phát Hiện Bất Thường</h6>
                    <p class="text-muted mb-0"><?php echo e($securityMetrics['login_anomalies'] ?? 0); ?> anomaly</p>
                </div>
            </a>
        </div>
    </div>
...
<script>
    ...
    const salesChartData = <?php echo json_encode($salesChart, 15, 512) ?>;
        ...
        if (type === 'revenue') {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [
                            ...
                            <?php echo e($stats['total_orders'] - $stats['pending_orders'] - $stats['completed_orders']); ?>, 
                            <?php echo e($stats['completed_orders']); ?>
            ...
            chartData = {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [
                            <?php echo e($stats['active_products']); ?>, 
                            <?php echo e($stats['total_products'] - $stats['active_products'] - $stats['low_stock']); ?>, 
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [
                            ...
                            <?php echo e($stats['new_users_month']); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views/admin/reports/dashboard.blade.php ENDPATH**/ ?>