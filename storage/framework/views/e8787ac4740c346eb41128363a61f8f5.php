...
<?php $__env->startSection('title', 'Coupon code'); ?>
...
<div class="row g-3 mb-4">
    <?php $__currentLoopData = $cpCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td><strong style="font-family:monospace;font-size:14px;letter-spacing:.5px"><?php echo e($c->code); ?></strong></td>
                    <td><span class="bs <?php echo e($c->type==='percentage' ? 'bs-medium' : 'bs-low'); ?>"><?php echo e($c->type === 'percentage' ? 'Percentage' : 'Fixed'); ?></span></td>
                    <td>
                        <?php if($c->type === 'percent'): ?>
                            <strong><?php echo e($c->value); ?>%</strong>
                            <?php if($c->max_discount): ?> <span style="color:var(--muted);font-size:11px">(max $<?php echo e(number_format($c->max_discount,2)); ?>)</span><?php endif; ?>
                        <?php else: ?>
                            <strong>$<?php echo e(number_format($c->value,2)); ?></strong>
                        <?php endif; ?>
                    </td>
                    <td style="color:var(--muted)"><?php echo e($c->min_order_amount > 0 ? '$'.number_format($c->min_order_amount,2) : '—'); ?></td>
                    <td><?php echo e($c->used_count); ?><?php echo e($c->usage_limit ? '/'.$c->usage_limit : ''); ?></td>
                    <td style="color:var(--muted);font-size:12px">
                        <?php if($c->expires_at): ?>
                            <?php if($c->expires_at->isPast()): ?>
                                <span style="color:#ef4444"><?php echo e($c->expires_at->format('d/m/Y')); ?> (Expired)</span>
                            <?php else: ?>
                                <?php echo e($c->expires_at->format('d/m/Y')); ?>
                    ...
                    <td>
                        <span class="bs <?php echo e($c->is_active && (!$c->expires_at || !$c->expires_at->isPast()) ? 'bs-active' : 'bs-blocked'); ?>">
                            <?php echo e($c->is_active && (!$c->expires_at || !$c->expires_at->isPast()) ? 'Active' : 'Inactive'); ?>

                        </span>
                    </td>
                    <td>
                        <div class="d-flex gap-1">
                            <button class="btn-icon btn-icon-primary" title="Edit" onclick="openEdit(<?php echo e($c->id); ?>, '<?php echo e($c->code); ?>', '<?php echo e($c->type); ?>', <?php echo e($c->value); ?>, <?php echo e($c->min_order_amount); ?>, <?php echo e($c->max_discount ?? 'null'); ?>, <?php echo e($c->usage_limit ?? 'null'); ?>, '<?php echo e($c->expires_at?->format("Y-m-d") ?? ""); ?>', <?php echo e($c->is_active ? 'true' : 'false'); ?>)">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form action="<?php echo e(route('admin.coupons.delete', $c->id)); ?>" method="POST" onsubmit="return confirm('Delete coupon <?php echo e($c->code); ?>?')">
        ...
        <div class="modal-content" style="border-radius:12px;overflow:hidden">
            ...
            <form action="<?php echo e(route('admin.coupons.store')); ?>" method="POST">
                ...
                <div class="modal-body">
                    <?php echo $__env->make('admin.coupons._form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
...
const couponByType   = <?php echo json_encode($couponByType, 15, 512) ?>;
const couponByStatus = <?php echo json_encode($couponByStatus, 15, 512) ?>;
const usagePerCoupon = <?php echo json_encode($usagePerCoupon, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views/admin/coupons/index.blade.php ENDPATH**/ ?>