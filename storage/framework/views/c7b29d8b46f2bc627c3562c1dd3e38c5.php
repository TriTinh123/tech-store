...
<div class="min-h-screen bg-gray-50 py-12 px-4">
    <div class="max-w-4xl mx-auto">
        <!-- Page Header -->
        <div class="mb-8">
            <a href="<?php echo e(route('notifications.index')); ?>" class="text-blue-600 hover:text-blue-700 font-medium mb-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" class="sr-only peer" <?php echo e($preferences->email_enabled ? 'checked' : ''); ?>
                    ...
                    <?php if($preferences->email_enabled): ?>
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-4">
                            <div>
                                ...
                                <input type="email" id="notification_email" name="notification_email"
                                       value="<?php echo e($preferences->notification_email ?? auth()->user()->email); ?>"
                            ...
                            <div>
                                ...
                                <select id="email_frequency" name="email_frequency"
                                    ...
                                    <option value="immediate" <?php echo e($preferences->email_frequency === 'immediate' ? 'selected' : ''); ?>>
                                        Immediately
                                    </option>
                                    <option value="daily" <?php echo e($preferences->email_frequency === 'daily' ? 'selected' : ''); ?>>
                                        Daily
                                    </option>
                                    <option value="weekly" <?php echo e($preferences->email_frequency === 'weekly' ? 'selected' : ''); ?>>
                                        Weekly
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="pt-3 border-t border-blue-200">
                                <p class="text-sm text-blue-700">
                                    Email verified: <?php echo e($preferences->email_verified ? 'Verified' : 'Not yet verified'); ?>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" class="sr-only peer" <?php echo e($preferences->sms_enabled ? 'checked' : ''); ?>
                    ...
                    <?php if($preferences->sms_enabled && $preferences->phone_verified): ?>
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                            <p class="text-sm text-green-700">
                                Verified phone number: <?php echo e($preferences->phone_number); ?>

                            </p>
                        </div>
                    <?php elseif($preferences->sms_enabled): ?>
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 space-y-4">
                            <div>
                                ...
                                <input type="tel" id="phone_number" name="phone_number"
                                       ...
                                       value="<?php echo e($preferences->phone_number ?? ''); ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                                       form="sms-form">
                            </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="in_app_enabled" class="sr-only peer"
                                   <?php echo e($preferences->in_app_enabled ? 'checked' : ''); ?>
        ...
        <div id="events-tab" class="hidden space-y-4">
            <form method="POST" action="<?php echo e(route('notifications.preferences.update')); ?>" id="preferences-form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_concurrent_login" class="sr-only peer"
                                   <?php echo e($preferences->notify_concurrent_login ? 'checked' : ''); ?>>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_suspicious_activity" class="sr-only peer"
                                   <?php echo e($preferences->notify_suspicious_activity ? 'checked' : ''); ?>>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_3fa_changes" class="sr-only peer"
                                   <?php echo e($preferences->notify_3fa_changes ? 'checked' : ''); ?>>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_ip_blocked" class="sr-only peer"
                                   <?php echo e($preferences->notify_ip_blocked ? 'checked' : ''); ?>>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_password_change" class="sr-only peer"
                                   <?php echo e($preferences->notify_password_change ? 'checked' : ''); ?>>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_new_device" class="sr-only peer"
                                   <?php echo e($preferences->notify_new_device ? 'checked' : ''); ?>>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-3">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_location_change" class="sr-only peer"
                                   <?php echo e($preferences->notify_location_change ? 'checked' : ''); ?>>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                </div>
            ...
            <form method="POST" action="<?php echo e(route('notifications.preferences.update')); ?>" id="preferences-form">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between pb-4 border-b border-gray-200">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="quiet_hours_enabled" class="sr-only peer"
                                       <?php echo e($preferences->quiet_hours_enabled ? 'checked' : ''); ?>
                        ...
                        <?php if($preferences->quiet_hours_enabled): ?>
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="time" id="quiet_hours_start" name="quiet_hours_start"
                                           value="<?php echo e($preferences->quiet_hours_start?->format('H:i') ?? '22:00'); ?>"
                                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                                </div>
                                <div>
                                    ...
                                    <input type="time" id="quiet_hours_end" name="quiet_hours_end"
                                           value="<?php echo e($preferences->quiet_hours_end?->format('H:i') ?? '08:00'); ?>"
                                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                                </div>
                            </div>
                        <?php endif; ?>
        ...
        <!-- Back Link -->
        <div class="mt-8">
            <a href="<?php echo e(route('profile.show')); ?>" class="text-blue-600 hover:text-blue-700 font-medium">
...
<!-- Forms -->
<form id="email-form" method="POST" action="<?php echo e(route('notifications.preferences.update-email')); ?>" class="hidden">
    <?php echo csrf_field(); ?>
    <input type="email" name="notification_email">
</form>

<form id="sms-form" method="POST" action="<?php echo e(route('notifications.preferences.setup-sms')); ?>" class="hidden">
    <?php echo csrf_field(); ?>
