...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 style="margin: 0; color: #1a202c; font-weight: 700;">Edit Category</h2>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $category->name)); ?>" required placeholder="Enter category name" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
...
unset($__errorArgs, $__bag); ?>" rows="4" placeholder="Enter category description" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;"><?php echo e(old('description', $category->description)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views\admin\categories\edit.blade.php ENDPATH**/ ?>