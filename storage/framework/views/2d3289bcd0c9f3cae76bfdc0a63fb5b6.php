            ...
            <div class="px-4 py-4">
                ...
                <div class="text-center mb-3">
                    <div class="amount-badge mx-auto">
                        ...
                        <span>$<?php echo e(number_format($paymentDetails['amount'], 2)); ?></span>
        ...
        <div class="pc-card">
            ...
            <div class="px-4 py-4">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted" style="font-size:14px">You will pay <strong>$<?php echo e(number_format($paymentDetails['amount'] ?? $order->total_amount, 2)); ?></strong> in cash when the delivery arrives.</p>
                </div>
            ...
            <div class="px-4 py-2">
                ...
                <div class="info-row">
                    ...
                    <span class="fw-bold" style="color:#e53e3e;font-size:14px">
                        $<?php echo e(number_format($oi->subtotal, 2)); ?>
                ...
                <div class="info-row">
                    ...
                    <span style="color:#16a34a;font-weight:600">-$<?php echo e(number_format($order->coupon_discount, 2)); ?></span>
                </div>
                <?php endif; ?>
