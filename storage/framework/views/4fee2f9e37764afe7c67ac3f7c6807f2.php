        ...
        <div class="col-md-7">
            <div class="card shadow-sm" style="border-radius:12px;overflow:hidden;border:none">
                <div class="card-header" style="background:linear-gradient(135deg,#667eea,#764ba2);padding:18px 24px;border:none">
                    ...
                    <p class="mb-0 mt-1" style="color:rgba(255,255,255,.7);font-size:13px">Order #<?php echo e($order->order_number); ?></p>
                </div>
                <div class="card-body p-4">
                    ...
                    <div style="background:#f8fafc;border-radius:8px;padding:14px 16px;margin-bottom:20px;border:1px solid #e2e8f0">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <strong style="font-size:13px">#<?php echo e($order->order_number); ?></strong>
                        </div>
                        <div class="d-flex justify-content-between mb-1">
                            <span style="font-size:12px;color:#6b7280">Total</span>
                            <strong style="font-size:13px;color:#e74c3c">$<?php echo e(number_format($order->total_amount, 2)); ?></strong>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span style="font-size:12px;color:#6b7280">Order Date</span>
                            <span style="font-size:12px"><?php echo e($order->created_at?->format('d/m/Y')); ?></span>
                        </div>
                    </div>

                    <form action="<?php echo e(route('orders.return.store', $order->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="reason" class="form-control" rows="5" required minlength="10" maxlength="1000"
                                ...
                                style="resize:none;font-size:13px"><?php echo e(old('reason')); ?></textarea>
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('orders.show', $order->id)); ?>" class="btn btn-outline-secondary flex-fill">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views\returns\create.blade.php ENDPATH**/ ?>