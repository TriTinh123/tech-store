...
<?php $__env->startSection('title', 'Contact — TechStore'); ?>
...
<div class="ct-wrap">
    ...
    <div class="ct-form-card">
        <?php if(session('success')): ?>
            <div class="cf-success"><i class="fas fa-check-circle"></i> <?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <div class="cf-title">Send us a message</div>
        <form method="POST" action="<?php echo e(route('contact.submit')); ?>">
            <?php echo csrf_field(); ?>
            <div class="cf-row">
                <div class="cf-group"><label class="cf-label">Your name <span style="color:#e84040">*</span></label><input type="text" name="name" class="cf-input" placeholder="John Doe" required value="<?php echo e(old('name')); ?>"></div>
                <div class="cf-group"><label class="cf-label">Email <span style="color:#e84040">*</span></label><input type="email" name="email" class="cf-input" placeholder="email@example.com" required value="<?php echo e(old('email')); ?>"></div>
            </div>
            <div class="cf-row">
                <div class="cf-group"><label class="cf-label">Phone</label><input type="tel" name="phone" class="cf-input" placeholder="090x-xxx-xxx" value="<?php echo e(old('phone')); ?>"></div>
                <div class="cf-group"><label class="cf-label">Subject <span style="color:#e84040">*</span></label><input type="text" name="subject" class="cf-input" placeholder="Your support request..." required value="<?php echo e(old('subject')); ?>"></div>
            </div>
            <div class="cf-group"><label class="cf-label">Message <span style="color:#e84040">*</span></label><textarea name="message" class="cf-textarea" placeholder="Enter your message..." required><?php echo e(old('message')); ?></textarea></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views\pages\contact.blade.php ENDPATH**/ ?>