...
<div class="wrap">
    ...
    <div class="body">
        ...
        <p>
            Someone is attempting to sign in to your <strong><?php echo e(config('app.name')); ?></strong> account.
        ...
        <div class="info-box">
            <div class="row">
                ...
                <span class="val"><?php echo e($ipAddress); ?></span>
            </div>
            <div class="row">
                <span class="label">🕐 Time:</span>
                <span class="val"><?php echo e(now()->format('d/m/Y H:i:s')); ?> (ICT)</span>
            </div>
        </div>
        ...
        <div class="btn-wrap">
            <a href="<?php echo e($confirmUrl); ?>" class="btn">
                ✅ I Confirm — Allow Sign-In
            </a>
        </div>

        <p class="url-text">Or paste this URL into your browser:<br><?php echo e($confirmUrl); ?></p>
    </div>

    <div class="footer">
        © <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> — This email was sent automatically by the security system.<br>
        Please do not reply to this email.
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\ADMIN\ecomerce\resources\views\emails\3fa-confirm.blade.php ENDPATH**/ ?>