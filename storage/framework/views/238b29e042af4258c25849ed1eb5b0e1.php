...
<div class="row g-3 mb-4">
    <?php $__currentLoopData = $catCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td style="color:var(--muted)"><?php echo e($cat->id); ?></td>
                    <td><span style="font-weight:500"><?php echo e($cat->name); ?></span></td>
                    <td style="color:var(--muted);max-width:260px"><?php echo e(\Str::limit($cat->description ?? '', 60)); ?></td>
                    <td><code style="font-size:12px;background:#f1f5f9;padding:2px 6px;border-radius:4px"><?php echo e($cat->slug); ?></code></td>
                    <td>
                        <div class="d-flex gap-1">
                            <a href="<?php echo e(route('admin.categories.edit', $cat->id)); ?>" class="btn-icon btn-icon-primary" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="<?php echo e(route('admin.categories.delete', $cat->id)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Delete this category?')">
...
(function(){
    ...
    const perCategoryData = <?php echo json_encode($perCategoryData, 15, 512) ?>;
    ...
    const chartDefs = {
        ...
        withProd:{
            ...
            build(ctx){
                const w=<?php echo e($withProducts); ?>, e=<?php echo e($emptyCategories); ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>