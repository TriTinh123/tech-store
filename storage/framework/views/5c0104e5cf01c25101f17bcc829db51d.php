...
<head>
    ...
    <title>Đăng Nhập - <?php echo e(config('app.name', 'Laravel')); ?></title>
...
<body>
    <div class="login-container">
        ...
        <div class="login-header">
            <h1>🔐 Đăng Nhập</h1>
            <p>Chào mừng quay lại <?php echo e(config('app.name', 'Shop')); ?></p>
        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="register-link">
                Chưa có tài khoản? <a href="<?php echo e(route('register')); ?>">Tạo tài khoản mới</a>
            </div>
    ...
    <script>
        ...
        function loginWithGoogle() {
            window.location.href = "<?php echo e(route('auth.google')); ?>";
        }
    </script>
