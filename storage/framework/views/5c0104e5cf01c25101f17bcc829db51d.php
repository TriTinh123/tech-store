...
<head>
    ...
    <title>Sign In &mdash; <?php echo e(config('app.name', 'TechStore')); ?></title>
        ...
        <div class="auth-form-wrap">
            ...
            <?php if($errors->any()): ?>
                <div class="a-error">
                    ...
                    <div class="a-error-body"><ul><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($e); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul></div>
                </div>
            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="switch-link">Don't have an account? <a href="<?php echo e(route('register')); ?>">Create one free</a></p>
...
<?php /**PATH C:\Users\ADMIN\ecomerce\resources\views/auth/login.blade.php ENDPATH**/ ?>