            ...
            <div class="p-6">
                ...
                <div class="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <p class="text-sm text-gray-600">
                        <span class="font-semibold">Tài khoản:</span> <?php echo e($user->email); ?>

                    </p>
                    <p class="text-sm text-gray-600 mt-1">
                        <span class="font-semibold">Mã OTP được gửi đến:</span> <?php echo e(substr($user->email, 0, 3)); ?>***<?php echo e(substr($user->email, strrpos($user->email, '@'))); ?>
                ...
                <!-- OTP Form -->
                <form method="POST" action="<?php echo e(route('3fa.verify-otp')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            inputmode="numeric"
                            pattern="[0-9]{6}"
                            class="w-full px-4 py-3 text-center text-2xl font-bold tracking-widest border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition-colors <?php echo e($errors->has('otp') ? 'border-red-500' : ''); ?>"
                            required
                            autofocus
                        />
                ...
                <div class="space-y-3">
                    ...
                    <?php if(app()->isLocal()): ?>
                        <a
                            href="<?php echo e(route('debug.otp', ['userId' => $user->id])); ?>"
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
                        ← Quay lại đăng nhập
                    </a>
                </div>
            </div>
...
<script>
    function resendOtp() {
        ...
        fetch('<?php echo e(route('3fa.resend-otp')); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views/auth/3fa/verify-otp.blade.php ENDPATH**/ ?>