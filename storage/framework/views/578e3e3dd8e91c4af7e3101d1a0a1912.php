...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" required placeholder="Enter product name" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slug')); ?>" required placeholder="product-slug" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
...
unset($__errorArgs, $__bag); ?>" rows="4" placeholder="Enter product description" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="manufacturer" class="form-control" value="<?php echo e(old('manufacturer')); ?>" placeholder="Manufacturer name" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('price')); ?>" required min="0" step="0.01" placeholder="0.00" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="original_price" class="form-control" value="<?php echo e(old('original_price')); ?>" min="0" step="0.01" placeholder="0.00" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
                </div>
                <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('stock')); ?>" required min="0" placeholder="0" style="padding: 0.5rem; border: 1px solid #e2e8f0; border-radius: 4px;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views\admin\products\create.blade.php ENDPATH**/ ?>