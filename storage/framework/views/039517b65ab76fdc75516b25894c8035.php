...
<?php $__env->startSection('title', 'Rating products'); ?>
...
<div class="row g-3 mb-4">
    <?php $__currentLoopData = $rvCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-6 col-md-3">
        <div class="stat-card stat-clickable" data-chart="<?php echo e($c['id']); ?>"
            ...
            <div class="stat-icon" style="background:<?php echo e($c['ibg']); ?>"><i class="fas <?php echo e($c['icon']); ?>" style="color:<?php echo e($c['ic']); ?>"></i></div>
            <div style="flex:1"><div class="stat-val"><?php echo e($c['val']); ?></div><div class="stat-lbl"><?php echo e($c['lbl']); ?></div></div>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row g-2">
            ...
            <?php $cnt = $stats[['','one','two','three','four','five'][$star]]; $pct = $stats['total'] > 0 ? round($cnt/$stats['total']*100) : 0; ?>
            <div class="col-12 col-md-6">
                <div class="star-bar">
                    <span style="font-size:12px;font-weight:600;width:18px;text-align:right"><?php echo e($star); ?></span>
                    <i class="fas fa-star" style="color:#f59e0b;font-size:11px"></i>
                    <div class="star-bar-bg"><div class="star-bar-fill" style="width:<?php echo e($pct); ?>%"></div></div>
                    <span style="font-size:12px;color:#64748b;width:50px"><?php echo e($cnt); ?> (<?php echo e($pct); ?>%)</span>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<form method="GET" action="<?php echo e(route('admin.reviews')); ?>" class="filter-bar">
    <input type="text" name="search" placeholder="Search name / content..." value="<?php echo e(request('search')); ?>" style="min-width:220px">
    <select name="rating">
        ...
        <option value="<?php echo e($s); ?>" <?php echo e(request('rating') == $s ? 'selected' : ''); ?>><?php echo e($s); ?> stars</option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
    ...
    <?php if(request('search') || request('rating') || request('product_id')): ?>
    <a href="<?php echo e(route('admin.reviews')); ?>" class="btn btn-sm btn-outline-secondary" style="border-radius:8px;font-size:13px">Clear filters</a>
    <?php endif; ?>
</form>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h6 class="mb-0">Reviews <span style="color:#94a3b8;font-weight:400">(<?php echo e($reviews->total()); ?> results)</span></h6>
    </div>
                ...
                <tr>
                    <td>
                        <div style="display:flex;align-items:center;gap:10px">
                            <div class="rv-avatar"><?php echo e(strtoupper(substr($review->user_name ?? 'U', 0, 1))); ?></div>
                            <div>
                                <div style="font-weight:600;color:#1a1f2e"><?php echo e($review->user_name); ?></div>
                                <div style="font-size:11px;color:#94a3b8"><?php echo e($review->user_email); ?></div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <?php if($review->product): ?>
                        <a href="<?php echo e(route('product.show', $review->product->id)); ?>" target="_blank"
                           style="color:#0984e3;text-decoration:none;font-weight:500;font-size:12px">
                            <?php echo e(Str::limit($review->product->name, 40)); ?>
                    ...
                    <td>
                        <div class="rv-stars">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <i class="fas fa-star<?php echo e($i > $review->rating ? ' empty' : ''); ?>"></i>
                            <?php endfor; ?>
                        </div>
                        <div style="font-size:11px;color:#64748b;margin-top:2px"><?php echo e($review->rating); ?>/5</div>
                    </td>
                    <td style="max-width:260px">
                        <?php if($review->comment): ?>
                        <div style="color:#374151;line-height:1.5"><?php echo e(Str::limit($review->comment, 100)); ?></div>
                        <?php else: ?>
                    ...
                    <td style="white-space:nowrap;color:#64748b">
                        ...
                        <span style="font-size:11px"><?php echo e($review->created_at->format('H:i')); ?></span>
                    </td>
                    <td class="text-end">
    ...
    <div class="card-footer d-flex justify-content-between align-items-center" style="font-size:12px;color:#64748b">
        <span>Show <?php echo e($reviews->firstItem()); ?>–<?php echo e($reviews->lastItem()); ?> / <?php echo e($reviews->total()); ?></span>
...
(function(){
    ...
    const ratingData = {
        five:  <?php echo e($stats['five']); ?>,
        four:  <?php echo e($stats['four']); ?>,
        three: <?php echo e($stats['three']); ?>,
        two:   <?php echo e($stats['two']); ?>,
        one:   <?php echo e($stats['one']); ?>,
    };
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views\admin\reviews\index.blade.php ENDPATH**/ ?>