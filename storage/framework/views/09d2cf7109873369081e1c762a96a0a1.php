...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'TechStore'); ?> — Premium Tech Accessories</title>
...
<body>
    ...
    <nav class="ts-navbar">
        <div class="ts-nb-in">
            <a href="<?php echo e(route('home')); ?>" class="ts-logo">
                <img src="/images/logo.jpg" alt="TechStore">
                <span class="ts-logo-t"><span class="t1">Tech</span><span class="t2">Store</span></span>
            </a>
            <form class="ts-search" action="<?php echo e(route('products.index')); ?>" method="GET">
            ...
            <div class="ts-actions">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php if($authUser->isAdmin()): ?>
                        <a href="<?php echo e(route('admin')); ?>" class="ts-btn" style="color:var(--danger)"><i class="fas fa-crown"></i><span>Admin</span></a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('profile.show')); ?>" class="ts-btn">
                        <?php if($authUser->face_photo): ?>
                            <img src="<?php echo e($authUser->face_photo); ?>" style="width:28px;height:28px;border-radius:50%;object-fit:cover;border:2px solid rgba(255,255,255,.5);vertical-align:middle;margin-right:4px">
                        <?php else: ?>
                            <i class="fas fa-user-circle"></i>
                        <?php endif; ?>
                        <span><?php echo e(Str::limit($authUser->name,10)); ?></span>
                    </a>
                    <a href="<?php echo e(route('wishlist')); ?>" class="ts-btn"><i class="fas fa-heart"></i><span>Wishlist</span></a>
                    ...
                    <div style="position:relative" id="notif-wrap" onmouseleave="startNotifHideTimer()" onmouseenter="showNotifMenu()">
                        ...
                        <div id="notif-drop" style="display:none;position:absolute;top:calc(100% + 6px);right:0;width:320px;background:#fff;border:1px solid #e2e8f0;border-radius:12px;box-shadow:0 8px 30px rgba(0,0,0,.15);z-index:9999;overflow:hidden">
                            ...
                            <div style="padding:10px 14px;border-top:1px solid #f1f5f9;text-align:center">
                                <a href="<?php echo e(route('notifications.index')); ?>" style="font-size:12px;color:var(--green);text-decoration:none"><i class="fas fa-list"></i> View all notifications</a>
                            </div>
                        </div>
                    </div>

                    <a href="<?php echo e(route('logout')); ?>" class="ts-btn" onclick="event.preventDefault();document.getElementById('lf-app').submit()"><i class="fas fa-sign-out-alt"></i><span>Sign Out</span></a>
                    <form id="lf-app" action="<?php echo e(route('logout')); ?>" method="POST" style="display:none"><?php echo csrf_field(); ?></form>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="ts-btn"><i class="fas fa-sign-in-alt"></i><span>Sign In</span></a>
                    <a href="<?php echo e(route('register')); ?>" class="ts-btn reg"><i class="fas fa-user-plus"></i><span>Sign Up</span></a>
                <?php endif; ?>
                <a href="<?php echo e(route('cart.index')); ?>" class="ts-btn" id="cart-nav-btn" style="position:relative">
    ...
    <div class="ts-catnav">
        <div class="ts-cn-in">
            <div class="ts-ci"><a href="<?php echo e(route('home')); ?>"><i class="fas fa-home"></i> Home</a></div>
            <div class="ts-ci"><a href="<?php echo e(route('about')); ?>"><i class="fas fa-info-circle"></i> About</a></div>
            <div class="ts-ci">
                ...
                <div class="ts-drop">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>"><i class="fas fa-star" style="color:var(--green)"></i> <strong>All Products</strong></a>
                </div>
            </div>
            <div class="ts-ci">
            ...
            <div class="ts-ci"><a href="<?php echo e(route('contact')); ?>"><i class="fas fa-envelope"></i> Contact</a></div>
            <div class="ts-ci"><a href="<?php echo e(route('news')); ?>"><i class="fas fa-newspaper"></i> News</a></div>
            <?php if(auth()->guard()->check()): ?>
            <div class="ts-ci ts-ci-ml"><a href="<?php echo e(route('orders.index')); ?>"><i class="fas fa-box-open"></i> My Orders</a></div>
            <div class="ts-ci"><a href="<?php echo e(route('compare.index')); ?>"><i class="fas fa-balance-scale"></i> Compare</a></div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="ts-mdrawer" id="tsMDrawer">
        ...
        <div class="ts-drawer-panel">
            ...
            <nav class="ts-drawer-nav">
                ...
                <a href="<?php echo e(route('products.index')); ?>?category=storage"><i class="fas fa-hdd"></i> Storage &amp; Connectivity</a>
                <a href="<?php echo e(route('products.index')); ?>?category=power"><i class="fas fa-plug"></i> Power &amp; Cooling</a>
                <a href="<?php echo e(route('products.index')); ?>"><i class="fas fa-star"></i> All Products</a>
                ...
                <a href="<?php echo e(route('profile.show')); ?>"><i class="fas fa-user"></i> My Profile</a>
            ...
            <div class="ts-drawer-ft">
                <a href="<?php echo e(route('login')); ?>" class="ts-dbtn-li">Sign In</a>
                <a href="<?php echo e(route('register')); ?>" class="ts-dbtn-su">Sign Up</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="ts-page-banner">
        <div class="ts-pb-in">
            <div class="ts-pb-title"><?php echo $__env->yieldContent('page_title'); ?></div>
    ...
    <?php if(session('security_warning')): ?>
        <?php $sw = session('security_warning'); ?>
        <div class="alert alert-warning alert-dismissible fade show m-3" role="alert" style="border-left:4px solid #f59e0b">
            ...
            <p class="mb-0 mt-1" style="font-size:13px">AI system detected a sign-in attempt with <strong><?php echo e(strtoupper($sw['level'])); ?></strong>. If this wasn't you, please change your password immediately.</p>
            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        </div>
    <?php endif; ?>
    ...
    <script>
        ...
        function loadNotifications() {
            fetch('<?php echo e(route("notifications.recent")); ?>', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
