...
<div class="card">
    ...
    <div class="btn-row">
        <a href="<?php echo e(route('login')); ?>" class="btn btn-admin"><i class="fa-solid fa-user-shield"></i> Sign in as Admin</a>
        <a href="<?php echo e(route('home')); ?>" class="btn btn-shop"><i class="fa-solid fa-bag-shopping"></i> Go to Shop</a>
    </div>

    <div class="divider"></div>
    <p class="footer-note">Access level insufficient &bull; <?php echo e(config('app.name')); ?></p>
</div>
</body>
</html><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views/errors/admin_denied.blade.php ENDPATH**/ ?>