...
<title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — TechStore Admin</title>
        ...
        <div id="admin-content-area">
            <?php if(session('face_enroll_prompt')): ?>
                <div class="alert alert-warning alert-dismissible fade show mx-3 mt-3" role="alert">
                    ...
                    <a href="<?php echo e(route('auth.face.enroll.form')); ?>" class="alert-link fw-bold">enroll your face here</a>.
...
</html><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views\layouts\admin.blade.php ENDPATH**/ ?>