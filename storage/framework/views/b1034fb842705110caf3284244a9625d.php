...
<div class="card">
    ...
    <div class="btn-row">
        <a href="<?php echo e(route('home')); ?>" class="btn btn-home"><i class="fa-solid fa-house"></i> Back to Home</a>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-login"><i class="fa-solid fa-right-to-bracket"></i> Sign In</a>
    </div>

    <div class="divider"></div>
    <p class="footer-note">Error 403 &mdash; Forbidden &bull; <?php echo e(config('app.name')); ?></p>
</div>
</body>
</html><?php /**PATH C:\Users\ADMIN\ecomerce\resources\views\errors\403.blade.php ENDPATH**/ ?>