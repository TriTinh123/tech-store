...
<div class="wrapper">
    <div class="card">
        <div class="header">
            ...
            <p><?php echo e(config('app.name')); ?> — Adaptive Security System</p>
        </div>
        <div class="body">
            <p class="greeting">
                Hello <strong><?php echo e($userName ?: 'there'); ?></strong>,<br>
        ...
        <div class="footer">
            © <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> — Automated email, please do not reply.
        </div>
    </div>
</div>
</body>
