    ...
    <div class="panel active" id="panel-question">
        <form method="POST" action="<?php echo e(route('auth.3fa.verify')); ?>">
            ...
            $viqMap = [
                ...
                'Tên thú cưng đầu tiên của bạn là gì?'      => 'What was the name of your first pet?',
                'Tên người bạn thân thời thơ ấu của bạn?'   => "What was your childhood best friend's name?",
                'Tên đệm của mẹ bạn là gì?'                 => "What is your mother's middle name?",
                'Tên anh/chị lớn tuổi nhất của bạn?'        => 'What is the name of your oldest sibling?',
                'Tên giáo viên yêu thích của bạn là gì?'    => 'What was the name of your favorite teacher?',
                'Biệt danh thời thơ ấu của bạn là gì?'      => 'What was your childhood nickname?',
                'Môn học yêu thích của bạn là gì?'          => 'What was your favorite subject in school?',
                'Bạn sinh ra ở thành phố nào?'               => 'What city were you born in?',
                'Bạn lớn lên trên con đường nào?'            => 'What street did you grow up on?',
                'Thành phố bạn muốn sống nhất?'              => 'What city would you most like to live in?',
                'Bộ phim yêu thích của bạn là gì?'           => 'What is your favorite movie?',
                'Món ăn yêu thích của bạn là gì?'            => 'What is your favorite food?',
                'Vận động viên yêu thích của bạn là ai?'     => 'Who is your favorite athlete/sports player?',
                'Ca sĩ/ban nhạc yêu thích của bạn là ai?'   => 'Who is your favorite singer/band?',
            ];
