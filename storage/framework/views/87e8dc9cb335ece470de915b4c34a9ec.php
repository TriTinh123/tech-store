...
<div class="wrap">
    ...
    <div class="body">
        ...
        <p>
            The security system of <strong><?php echo e(config('app.name')); ?></strong> detected a
        ...
        <div class="info-box">
            <div class="row">
                ...
                <span class="val"><?php echo e($userEmail); ?></span>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <span class="val"><?php echo e($userAgent); ?></span>
            </div>
            <div class="row">
                <span class="label">🕐 Time:</span>
                <span class="val"><?php echo e($attemptedAt); ?></span>
            </div>
        </div>
    ...
    <div class="footer">
        © <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> — This is an automated security notification.<br>
        Please do not reply to this email.
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\ADMIN\ecomerce\resources\views/emails/face-alert.blade.php ENDPATH**/ ?>